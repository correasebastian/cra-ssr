...
module.exports = function (api, opts, env) {
  ...
  var isEnvServer = env === 'server';
  var isEnvTest = env === 'test';
  var isProdOrServer = isEnvProduction || isEnvServer

  var useESModules = validateBoolOption(
    'useESModules',
    opts.useESModules,
    isEnvDevelopment || isProdOrServer
  );
  ...
  if (!isEnvDevelopment && !isEnvProduction && !isEnvTest && !isEnvServer) {
    throw new Error(
